...
class Lite extends Driver
{
    ...
    {
        return $this->options['path'] . $this->options['prefix'] . md5($name) . 'Admin.php';
    }
    ...
    public function clear($tag = null)
    {
        ...
        array_map("unlink", glob($this->options['path'] . ($this->options['prefix'] ? $this->options['prefix'] . DS : '') . '*Admin.php'));
    }
}
